...
communicate_spec(){
  ...
  python3 -m spec communicate \
                          --seed 42 \
                          --gpu-id 0  \
                          --output-dir "runs/posthoc-communicate-agnews-${activation}-${cheat_ratio}/" \
                          --load "data/saved-models/test-agnews-softmax/" \
                          --save "data/saved-models/posthoc-communicate-agnews-${activation}-${cheat_ratio}/" \
                          --save-explanations "data/debug-explanations/agnews-cosloss-${activation}-${cheat_ratio}.txt" \
