...
communicate_spec(){
  ...
  python3 -m spec communicate \
                          --seed 42 \
                          --gpu-id 3  \
                          --output-dir "runs/eraser-max-out-communicate-sst-${activation}/" \
                          --load "data/saved-models/test-sst-${activation}/" \
                          --save "data/saved-models/eraser-max-out-communicate-sst-${activation}/" \
                          --save-explanations "data/explanations/eraser_max_out_sst_test.txt" \
