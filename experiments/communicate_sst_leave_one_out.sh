...
communicate_spec(){
  ...
  python3 -m spec communicate \
                          --seed 42 \
                          --gpu-id 0  \
                          --output-dir "runs/leave-one-out-communicate-sst-${activation}/" \
                          --load "data/saved-models/test-sst-${activation}/" \
                          --save "data/saved-models/leave-one-out-communicate-sst-${activation}/" \
                          --save-explanations "data/explanations/leave_one_out_sst_test.txt" \
