...
communicate_spec(){
  ...
  python3 -m spec communicate \
                          ...
                          --output-dir "runs/communicate-esnli-without-neutral-fixed/" \
                          --save "data/saved-models/communicate-esnli-without-neutral-fixed/" \
                          --save-explanations "data/explanations-all/esnli-fixed.txt" \
